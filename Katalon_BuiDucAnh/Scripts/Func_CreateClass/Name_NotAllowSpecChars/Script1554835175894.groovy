...
WebUI.setText(findTestObject('Login/Page_Hc liu - Sch Mm/input_Tn_form-control ng-pristine ng-invalid ng-touched'), '!@#$%^&*()_+Test  asdz')
...
WebUI.waitForElementVisible(findTestObject('CreateClass/Error/Error_SpecCharsNotAllow'), 0)
